...
public class myAnimation {
    ...
    public myAnimation(ImageView pImageView, int[] pFrameRess, int[] pDurations) {
    ...
    public myAnimation(ImageView pImageView, int[] pFrameRess, int pDuration) {
        mImageView = pImageView;
        mFrameRess = pFrameRess;
        mDuration = pDuration;
        mLastFrameNo = pFrameRess.length - 1;
...
//        playConstant(1);
    ...
    public myAnimation(ImageView pImageView, int[] pFrameRess, int pDuration, long pBreakDelay) {
        mImageView = pImageView;
        mFrameRess = pFrameRess;
        mDuration = pDuration;
        mLastFrameNo = pFrameRess.length - 1;
