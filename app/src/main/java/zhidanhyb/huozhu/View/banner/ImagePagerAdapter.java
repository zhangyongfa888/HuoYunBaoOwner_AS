...

{
    ...
    public View getView(int position, View view, ViewGroup container)
    {
        ...
        String site=mList.get(position).getSite();
        String adPicUrl=null;
        if (site.equals("1")){
            adPicUrl=mList.get(position).getAdPicUrl();
        }

        MyBitmapUtil.getInstance(context).setBitmap(holder.imageView, HttpConfigSite.Base_ImageView_url+adPicUrl);
        return view;
    }
