...
//    private ScrollView scrollView;
    ...
    int backcolor = Color.rgb(221, 221, 221);
...
//        views.setBackgroundColor(Color.parseColor("#000000"));
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(context.getResources().getColor(R.color.text_v2));
            } else {
                itemView.setTextColor(context.getResources().getColor(R.color.hint_v2));
            }
        }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(context.getResources().getColor(R.color.hint_v2));
